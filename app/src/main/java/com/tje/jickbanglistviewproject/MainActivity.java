...
public class MainActivity extends AppCompatActivity {
    ...
    void fillApp(){
        appList.add(new App("100/13","2층","경상북도 구미시 송정동","분리형 원룸","[풀옵션강력추천]번개시장근.."));
        appList.add(new App("100/15","3층","경상북도 구미시 신평동","분리형 원룸","[풀옵션강력추천]ㅋㅋㅋㅋ.."));
        appList.add(new App("100/13","3층","경상북도 구미시 원평동","분리형 원룸","[풀옵션강력추천]ㅎㅎㅎㅎ.."));
        appList.add(new App("100/13","2층","경상북도 구미시 형곡동","분리형 원룸","[풀옵션강력추천]ㅋㅋㅋㅋㅋ.."));
        appList.add(new App("100/15","1층","경상북도 구미시 신평동","분리형 원룸","[풀옵션강력추천]ㅎㅎㅎㅎ.."));
